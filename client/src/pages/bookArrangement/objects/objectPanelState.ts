...
export const objectKindLabels = { event: "事件", scene: "场景", relation: "关系阶段", hook: "伏笔计划", hookNode: "线索生命周期节点", foreshadow: "伏笔历史快照", check: "核对问题" };
export const objectRemoval = {
  ...
  hookNode: { action: "移除生命周期节点", explanation: "节点会停用，线索本身和历史正文保持原样。" },

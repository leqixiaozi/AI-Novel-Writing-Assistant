...
export function ArrangementVolumePreview({ workspace, preview, currentDraftRevision, busy = false, disabled = false, applied = false, onApply }: ArrangementVolumePreviewProps) {

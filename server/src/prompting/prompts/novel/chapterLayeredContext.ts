...
export function buildChapterWriteContext(input: {
  ...
  return {
    ...
    ...(dynamicCharacterGuidance.plannedRelationStages?.length ? { plannedRelationStages: dynamicCharacterGuidance.plannedRelationStages } : {}),
    ...
    ...(input.contextPackage.plannedHookGuidance ? { plannedHookGuidance: input.contextPackage.plannedHookGuidance } : {}),

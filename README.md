...
- 统一入口现在分别提供新版和旧版前端：`/new-design/*` 由新版独立页面加载，不再等待旧版 API；旧版仍保留原地址。实测新版书架和第四章工作台已显示，新版菜单只选中“我的书籍”；书架卡片的继续按钮恢复横排可读。
...
- 旧版和新版共用本地入口地址，但使用独立路径、前端和菜单；两边可明确切换，从新版书架进入书籍后菜单保持一致。

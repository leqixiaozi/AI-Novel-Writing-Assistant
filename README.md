...
- 全书编排采用浅蓝工作台与彩色出场区段，保留计划虚线和历史实线；章节窗口可像滚动条一样拖动，关系、伏笔和核对资料可定位来源。
...
开发说明见 [可选人工调整](./docs/wiki/workflows/optional-writing-adjustments.md)，验收边界见 [实施检查点](./docs/checkpoints/2026-09-13-optional-writing-adjustments.md)。

...
- 事件、场景、关系与伏笔可在右侧查看来源、编辑和预览影响；人物参与支持移动、拆分与合并，表达曲线可调整档位。
...
开发说明见 [可选人工调整](./docs/wiki/workflows/optional-writing-adjustments.md) 与 [全书编排](./docs/wiki/product/book-arrangement.md)，验收边界见 [人工调整检查点](./docs/checkpoints/2026-09-13-optional-writing-adjustments.md) 与 [编排检查点](./docs/checkpoints/2026-09-13-book-arrangement.md)。

...
export interface AuthorTimelinePreviewInput {requestKey:string;expectedSourceHash:string;command:AuthorTimelineCommand;candidateSource?:import("../characterExperiences").ExperienceCandidateSource;}
...
export interface AuthorTimelineReceipt {bookId:string;requestKey:string;inputHash:string;operation:AuthorTimelineCommand["operation"];result:StoryTimeProposal|StoryRelationProposal|StoryNarrativeOccurrence;repeated:boolean;candidateSource?:import("../characterExperiences").ExperienceCandidateSource;}

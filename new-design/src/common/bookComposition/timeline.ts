...
export interface AuthorTimelinePreviewInput {requestKey:string;expectedSourceHash:string;command:AuthorTimelineCommand;}
...
export interface AuthorTimelineReceipt {bookId:string;requestKey:string;inputHash:string;operation:AuthorTimelineCommand["operation"];result:StoryTimeProposal|StoryRelationProposal|StoryNarrativeOccurrence;repeated:boolean;}

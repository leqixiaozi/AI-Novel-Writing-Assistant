...
export interface KnowledgeWorkspace {bookId:string;bookLabel:string;items:KnowledgeReferenceItem[];nextCursor:string|null;owners:KnowledgeOwnerChoice[];capabilities:{textParsing:true;keywordSearch:true;vectorSearch:boolean;vectorReason:string;settingsRoute:string};truncated:boolean}

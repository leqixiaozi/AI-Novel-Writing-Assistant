...
export const AUTHOR_TASK_KINDS=["ai_task","creation_session","creation_batch","planning_run","planning_review","production_director","writing_request","settlement_session","settlement_extraction","research_version","research_adoption","export_request","completion_check","quality_issue"] as const;

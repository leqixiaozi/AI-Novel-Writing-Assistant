...
export interface ChapterWritingChapter {chapterCardId:string;planningObjectId:string;volumePlanningObjectId:string|null;volumeTitle:string;title:string;logicalOrder:number;hasAdoptedPlan:boolean;planningVersionId:string|null;planningVersionNumber:number|null;documentId:string|null;documentRevision:number|null;candidateCount:number;adoptedBodyVersionId:string|null;pendingRequestCount:number;openIssueCount:number;state:"needs_plan"|"ready"|"writing"|"review"|"adopted";updatedAt:string;}

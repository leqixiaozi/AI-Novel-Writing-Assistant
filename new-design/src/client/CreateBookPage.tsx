...
export default function CreateBookPage() {
  ...
  return <div className="nd-shell nd-create-flow">
    <header className="nd-create-header"><div><a href="/new-design/books">← 返回我的书籍</a><p className="nd-eyebrow">新设计 · 统一开书</p><h1>从你现在拥有的内容开始</h1><p>入口只决定第一次怎么准备内容。创建后都会进入相同的创作表单和本书资料。</p></div><ol className="nd-stepper"><li className={step>=1?"is-active":""}><b>1</b><span>选择起点</span></li><li className={step>=2?"is-active":""}><b>2</b><span>AI 理解</span></li><li className={step>=3?"is-active":""}><b>3</b><span>确认方向</span></li><li className={step>=4?"is-active":""}><b>4</b><span>建立书籍</span></li></ol></header>

...
export default function TemplateGroupsPage(){
  const [referenceLocked,setReferenceLocked]=useState(false),[associationLocked,setAssociationLocked]=useState(false);
  ...
  const locked=referenceLocked||associationLocked||recovery.locked||syncRecovery.locked,dirty=!!draft&&structureDraftHash(draft)!==baseline.current;

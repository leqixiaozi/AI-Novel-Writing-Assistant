import type { CardGroupFormDefinition, CardTypeSummary } from "../common/contracts";

export default function FormDefinitionPreview({ definition, cardTypes = [] }: { definition: CardGroupFormDefinition; cardTypes?: CardTypeSummary[] }) {
  const typeNameByKey = new Map(cardTypes.map((item) => [item.key, item.name]));
  return (

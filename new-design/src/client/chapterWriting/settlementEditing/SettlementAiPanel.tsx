...
export default function SettlementAiPanel({workspace,disabled,onLockChange,onReadWorkspace}:{workspace:ChapterSettlementEditingWorkspace;disabled:boolean;onLockChange:(locked:boolean)=>void;onReadWorkspace:()=>Promise<void>}){

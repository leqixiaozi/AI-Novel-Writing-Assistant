...
export const newDesignApi = {
  ...
  getBookReading:(bookId:string,chapter?:string)=>request<import('../common/bookshelf').BookReading>(`/books/${encodeURIComponent(bookId)}/reading${chapter?'?chapter='+encodeURIComponent(chapter):''}`),

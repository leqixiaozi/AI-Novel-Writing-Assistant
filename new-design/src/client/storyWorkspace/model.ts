...
export function hasAmbiguousNavigation(query:URLSearchParams):boolean {return ['tab','scope','selected','plan','type','new','detail','relation','returnTo','batch','batchMode','experienceBatch'].some(key=>query.getAll(key).length>1);}

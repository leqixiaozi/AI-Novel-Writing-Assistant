...
export default function HomePage() {
  ...
  return <main className="nd-shell nd-home" aria-busy={loading}>
    <header className="nd-home-heading"><div><p className="nd-kicker">你的创作工作台</p><h1>创作首页</h1></div><nav aria-label="首页常用操作"><a href="/new-design/books">我的书籍</a><a href="/new-design/books/new">＋ 开始新故事</a><button type="button" onClick={retry} disabled={loading}>{loading ? "读取中…" : "刷新进展"}</button></nav></header>

...
export function buildProfessionalResourceTree(resources:ProfessionalResource[],filters:{search:string;favoritesOnly:boolean;includeArchived:boolean}):ProfessionalDirectoryNode[]{

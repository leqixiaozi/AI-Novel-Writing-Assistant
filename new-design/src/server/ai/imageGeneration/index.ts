...
import type {ComicImageProtocolInput} from "../../../common/comicRendering";
...
export async function executeImageProtocol(input:ImageGenerationInput|PublicImageProtocolInput|ComicImageProtocolInput,connection:ImageConnectionVersion,credential:string|null):Promise<ImageGenerationReply>{

...
export const creationAssets: PromptAsset[] = [
  {
    assetId: "new_design.creation.directions", version: "v3", taskType: "directions", label: "推荐开书方向",
  ...
  {
    assetId: "new_design.creation.initial_content", version: "v4", taskType: "initial_content", label: "准备开书资料",
    contextPolicy: "explicit_task_snapshot_only", temperature: 0.6, maxTokens: 16384,
  ...
  {
    assetId: "new_design.forms.assist", version: "v3", taskType: "form_assist", label: "准备表单建议",

...
export const PROMPT_TASK_TYPES = ["directions", "initial_content", "form_assist", "market_analysis", "book_analysis", "planning_candidate"] as const;
...
export interface PromptAsset extends PromptAssetMetadata {
  instruction: string;
  prepare(input: unknown): { input: unknown; schema: z.ZodType };
}

...
export function createIndependentAiGateway(options:ExecutionDependencies={}):NewDesignAiGateway {
  ...
  return {
    generateComicCandidate:input=>execute<any>('comic_generation',input),
    generateDramaCandidate:input=>execute<any>('drama_generation',input),

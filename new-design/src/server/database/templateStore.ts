...
export interface TemplatePayload { cardTypes:PayloadType[];dictionaries:PayloadDictionary[];relationTypes:PayloadRelation[];forms:PayloadForm[];seedCards:PayloadCard[];menu:{defaultPage:string;pages:string[]}; }

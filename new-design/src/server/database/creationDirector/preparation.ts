...
export interface CreationPreparationPlan {format:1;input:CreationPreparationPromptInput;inputHash:string;taskType:PromptTaskType;assetId:string;assetVersion:string;messages:PreparedPrompt["messages"];outputSchema:Record<string,unknown>;route:ManagedTaskRoute;modelSnapshot:ManagedModelSnapshot;templateSnapshot:unknown;catalogHash:string;carriedOutput:CreationPreparationOutput|null;sourceBatches:Array<{id:string;outputHash:string;inputHash:string}>;}

...
exports.isolatedDatabase=async function(t,extraMigrations=[]){
 ...
 const runtimePath=require.resolve('../../dist/server/database/runtime');
 require.cache[runtimePath]={id:runtimePath,filename:runtimePath,loaded:true,exports:{getNewDesignPool:async()=>pool,getInitializedNewDesignPool:async()=>pool}};

...
- 新版新增独立“漫画工作台 Beta”的项目入口：按来源、内容、形态、画风四步创建，支持小说已采用正文导入、原创灵感和本地文本；来源冻结为可追溯版本，重复创建可按原请求核对。分集大纲、整话分格脚本和角色／场景文字设定均可人工保存候选并明确采用，旧版本不被覆盖。作者环境尚未启用，AI 生成、视觉素材、图片生成及导出尚未接入。
- 新版世界样本库支持可恢复归档：归档样本不再供新书导入或继续发布，已导入作品、固定版本与来源记录保留；查看归档样本后可明确恢复。作者环境尚待启用和页面验收。
- 漫画来源页增加人工梗概、情节节拍和角色线索整理：每次保存均为候选，明确采用后保留原文及旧版，未知结果可按原请求找回。AI 自动提取仍未接入，作者环境尚未安装对应手动迁移。

...
- 旧版侧栏只展示旧版功能菜单，新版侧栏只展示新版菜单；两边提供明确的版本切换入口。跨版本跳转会完整加载对应页面，从新版书架进入书籍后左侧菜单保持一致。
- 本地统一入口按路径分别加载旧版与新版前端。新版书架、章节深链和模型设置不再被旧版服务启动状态拦住；旧版地址与 API 转发保持原路径。新版书架只高亮“我的书籍”，卡片继续按钮不再被操作图标挤成竖排。
...
- 旧版与新版可从共同本地入口访问；“开书前标题”可从新版菜单进入，两套页面按路径独立加载。

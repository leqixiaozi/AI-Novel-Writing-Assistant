...
- 新版新增独立“漫画工作台 Beta”的项目入口：按来源、内容、形态、画风四步创建，支持小说已采用正文导入、原创灵感和本地文本；来源冻结为可追溯版本，重复创建可按原请求核对。分集大纲和整话分格脚本均可人工保存多个候选并明确采用，旧版本不被覆盖。作者环境尚未启用，AI 生成、人物／场景素材、图片生成及导出尚未接入。

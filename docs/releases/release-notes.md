...
- 左侧“创作”区域新增“新设计”工作台，可以创建人物等元卡片类型，配置字段名称、说明、类型、必填、默认值、选项、分组和顺序，并在编辑时实时查看最终表单。
...
- 新设计提供人物、组织、地点、道具、世界规则、事件、目标、冲突、真相、线索、伏笔、悬念、剧情线、剧情节点、弧线、主题、卷、章节和场景 19 类通用卡片，并可声明正文、时间、状态、关系、生命周期、创作目标和正典事实等组合能力。
...
- 新设计新增“我的卡片”三类资源树：业务资源、AI 资源和各本书的正式小说事实入口；新增唯一的“提示词组件”类型和四条中性组件，可用动态表单新建、编辑、查看版本、归档和恢复。
...
- 新设计市场雷达可手动扫描番茄、起点和晋江的公开榜单；扫描不调用模型且按来源独立保存，失败不会清掉其他来源或旧版本。作者明确勾选作品后才启动 AI 分析，九类结论先作为候选展示，逐条确认后才保存为可追溯的市场信号卡，不会自动创建书籍。
...
- 新设计的布局、卡片、表单和状态提示统一跟随主应用主题，可在墨砚、暖纸、夜航及其明暗模式下保持一致；进入卡片库时会直接打开已有的第一张卡片，减少空白等待和多余点击。
- 侧栏底部新增独立的“新设计”分组，新设计入口从创作区移入该分组；创作、资产、系统和新设计分组标题均可点击展开或收起，长菜单浏览更轻松。
- 新设计调整为最终导航层级：首页默认引导进入“我的书籍”，结构设计中心集中提供元卡片类型、字典与关系、卡片组表单和模板组；旧小说工作台及其 SQLite 数据路径保持不变。
